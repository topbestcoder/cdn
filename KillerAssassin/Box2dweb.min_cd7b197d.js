...
(function () {
   ...
   function b2ContactListener(field) {
...
(function () {
   ...
   b2PolygonShape.prototype.SetAsVector = function (vertices, vertexCount) {
      ...
      this.m_centroid = b2PolygonShape.prototype.ComputeCentroid(this.m_vertices, this.m_vertexCount);
...
(function () {
   ...
   b2ContactListener.b2ContactListener = function (field) {this.that=field};
...
(function () {
   ...
   b2RopeJoint.prototype.GetLocalAnchorB = function (target) {
      return this.m_localAnchorB;
   }
   b2RopeJoint.prototype.SetMaxLength = function (length) {
      this.m_maxLength = length;
   }
   b2RopeJoint.prototype.GetMaxLength = function (maxForce) {
   ...
   b2RopeJoint.prototype.SolveVelocityConstraints = function (step) {
      ...
      this.m_impulse = b2Math.Min(0,this.m_impulse+impulse);
   ...
   b2RopeJointDef.prototype.Initialize = function (bA, bB, anchorA, anchorB, maxLength) {
      this.bodyA = bA;
      this.bodyB = bB;
      this.localAnchorA.SetV( this.bodyA.GetLocalPoint(anchorA));
      this.localAnchorB.SetV( this.bodyB.GetLocalPoint(anchorB));
